...
CPPFLAGS =  -I$(AUROBOTDIR)/include  -I/usr/include/opencv2 -I/usr/include/eigen3 -I./GridMap/src -I./Astar/src
#
...
# C++ compiler flags
#-pedantic
CXXFLAGS = -g3 -O0 -Wall -std=c++11 -pedantic -fPIC $(DEFINES)
